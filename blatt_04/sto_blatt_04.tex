...
%
                ...
                \begin{proof}
                    ...
                    % Hier solltest du statt C eine andere Benennung wählen,
                    % C hast du ja schon als Kante definiert:)
                    % Lennart: Wäre besser ...
                    ...
                    \begin{equation*}
                       ...
                       \end{split}
                    \end{equation*}
%					Hier hätte ich noch weiter aufgeteilt zu $P(A\cap B)=P(A)\cdot P(B) aber es klappt 							ja auch gut so wie es jetzt ist.^^
