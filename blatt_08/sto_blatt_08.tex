        ...
        \begin{proof}
            ...
            \begin{equation*}
                \begin{split}
                    \var(X) &= \e(X^2) - (\e(X))^2 \\
                            &= \e(X^2) \\
%Was machst du als nächstes? Für den Transformationssatz müsste das Quadrat zum x, sonst kannst du auch nicht die 1/21 rausziehen. Die Werte hab ich aber auch mit meiner verschobenen Gleichvtl. raus 
