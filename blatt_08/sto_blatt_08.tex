...
\begin{enumerate}[label=\bfseries\arabic*.]
    ...
    \item
        \begin{enumerate}[label=(\alph*)]
            \item
                Seien $X$, $Y$, $Z$ reelwertige Zufallsvariablen auf einem
            ...
            \item
                Sei $X$ eine reelwertige Zufallsvariable auf einem diskreten
    ...
    \item
        Seien $X$, $Y$ reelwertige Zufallsvariablen auf einem diskreten
