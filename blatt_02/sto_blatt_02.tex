...
\usepackage{fancyhdr}
\pagestyle{fancy}
\lhead{Stochastik 1 - Gruppe 5 - Blatt 2}
...
\begin{enumerate}[label=\bfseries\arabic*.]
    ...
    \item
        \begin{behaupt}
            Die Wahrscheinlichkeit in der gegebenen Situation drei gleichfarbige
            Gummibärchen zu ziehen liegt bei ca. \num{0,874}.
        \end{behaupt}
        
        \begin{proof}
% Oh man, bin nicht auf die Idee gekommen die Gummibärchen als unterscheidbar anzunehmen. Hab die ganze Zeit erfolglos versucht das irgendwie sinnvoll in eins unserer Systeme zu bringen ^^ Das Ergebnis hatte ich aber auch. Sollte daher stimmen ^^ Kann man in Github irgendwie Kommentare zu commits machen?      
